...
NpartLeft = int(Npart*0.5)

weighte = n0*cell_length[0]*cell_length[1]/particles_per_cell
weightp = n0p*cell_length[0]*cell_length[1]/particles_per_cell
weightpp = n0pp*cell_length[0]*cell_length[1]/particles_per_cell

coordse1 = np.zeros([2+1, Npart - NpartLeft])
coordse2 = np.zeros([2+1, NpartLeft])

coordsp1 = np.zeros([2+1, Npart - NpartLeft])
coordsp2 = np.zeros([2+1, NpartLeft])

coordspp1 = np.zeros([2+1, Npart - NpartLeft])
coordspp2 = np.zeros([2+1, NpartLeft])
...
for i in range(NpartLeft):
    coordsp1[0][i] = np.random.rand()*grid_length[0]*0.5
    coordsp1[1][i] = np.random.rand()*grid_length[1]
    coordsp1[2][i] = weightp
for i in range(Npart-NpartLeft):
    coordsp2[0][i] = (1.0 + np.random.rand())*grid_length[0]*0.5
    coordsp2[1][i] = np.random.rand()*grid_length[1]
    coordsp2[2][i] = weightp

Species(
	name = 'protons1',
	position_initialization = coordsp1,
...
Species(
	name = 'protons2',
	position_initialization = coordsp2,
	momentum_initialization = 'maxwell-juettner',
	ionization_model = 'none',
	#c_part_max = 1.0,
	pusher = 'vay',
...
for i in range(NpartLeft):
    coordspp1[0][i] = np.random.rand()*grid_length[0]*0.5
    coordspp1[1][i] = np.random.rand()*grid_length[1]
    coordspp1[2][i] = weightpp
for i in range(Npart-NpartLeft):
    coordspp2[0][i] = (1.0 + np.random.rand())*grid_length[0]*0.5
    coordspp2[1][i] = np.random.rand()*grid_length[1]
    coordspp2[2][i] = weightpp

Species(
	name = 'positrons1',
	position_initialization = coordspp1,
	momentum_initialization = 'maxwell-juettner',
	ionization_model = 'none',
	#c_part_max = 1.0,
	pusher = 'vay',
...
Species(
	name = 'positrons2',
	position_initialization = coordspp2,
	momentum_initialization = 'maxwell-juettner',
	ionization_model = 'none',
	#c_part_max = 1.0,
	pusher = 'vay',
...
for i in range(NpartLeft):
    coordse1[0][i] = np.random.rand()*grid_length[0]*0.5
    coordse1[1][i] = np.random.rand()*grid_length[1]
    coordse1[2][i] = weighte
for i in range(Npart-NpartLeft):
    coordse2[0][i] = (1.0 + np.random.rand())*grid_length[0]*0.5
    coordse2[1][i] = np.random.rand()*grid_length[1]
    coordse2[2][i] = weighte
